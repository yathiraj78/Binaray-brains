...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;">
    ...
    <div class="main-container" style="display: flex; justify-content: center; align-items: center; height: 80vh;">
        <div class="img-container" style="text-align: center; margin-right: 20px;">
            <img src="images\logo.jpg" alt="Social Club Image" style="max-width: 200px; max-height: 200px;">
        </div>
        <div class="container" style="background: white; padding: 20px; border-radius: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
